    ...
    <div className="mt-5 flex items-center gap-4">
      ...
      >
        <svg
          ...
          className="w-10 h-10 transition-transform duration-300 group-hover:scale-110"
        >
          {/* Outlined speech bubble shape */}
          <path
            d="M16 3a13 13 0 0 0-11.3 19.4L3 29l6.8-1.8A13 13 0 1 0 16 3z"
            fill="none"
            stroke="#25D366"
            strokeWidth="1.8"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          {/* Solid phone handset inside */}
          <path
            d="M20.5 17.5c-.3-.2-1.5-.7-1.7-.8-.2-.1-.4-.1-.6.2-.2.3-.7.9-.9 1.1-.2.2-.3.2-.6.1-.3-.2-1.3-.5-2.4-1.5-1-1-1.6-2-1.8-2.3-.2-.3 0-.5.1-.6s.3-.3.4-.5c.1-.2.2-.3.3-.5.1-.2 0-.4-.1-.5-.1-.1-.6-1.5-.8-2-.2-.5-.4-.4-.6-.4h-.5c-.2 0-.5.1-.7.4-.2.3-.9 1-1 2.2 0 1.2.9 2.4 1 2.6.1.2 1.8 2.8 4.4 3.9.6.3 1.1.4 1.5.6.6.2 1.2.2 1.6.1.5-.1 1.5-.6 1.7-1.2.2-.6.2-1.1.1-1.2-.1-.1-.3-.2-.6-.3z"
            fill="#25D366"
          />
        </svg>
      </a>
